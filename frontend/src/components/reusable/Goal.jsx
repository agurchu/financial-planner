...
export default function Goal({current_cash, target_cash, name,startDate,totalMonths}) {
...
// toggle visibility of circular progress bars
  ...
  return (<>
    <button onClick={toggleDetails} className='px-4 bg-primary-1/5 hover:bg-accent transition-all duration-200 ease-in-out py-2 border-l-[1px] border-t-[1px] border-primary-1/25 rounded-2xl'>
    ...
    {showDetails &&
      <GoalProcess toggleDetails={toggleDetails} startDate={startDate} totalMonths={totalMonths}/>}
    </>)
}
